...
function handleInsert(sql, params) {
  ...
  if (lower.includes('into users')) {
    const user = { id: uuid(), full_name: params[0], email: params[1], phone: params[2], password_hash: params[3], role: params[4] || 'youth', avatar_url: null, region: null, province: null, language_pref: 'kinyarwanda', cultural_background: [], voice_intro_url: null, interests: [], bio: null, clan: null, age: null, is_verified: false, onboarding_status: false, created_at: new Date().toISOString(), updated_at: new Date().toISOString() };
